...
export const Custom404: VFC = () => (
  <div className="flex justify-center items-center">
    <div className="py-24 px-4 w-full max-w-7xl text-center bg-gray-100 rounded sm:px-6 lg:px-8">
      <div className="gap-x-4 justify-center items-center md:flex md:divide-x md:divide-gray-400">
